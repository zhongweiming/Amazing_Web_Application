...
<HEADER>
    ...
    <link href="styles/cart.css" media="screen" rel="stylesheet" type="text/css" />
...
<div class="cart-wrap">
    <table id="cartTable" class="cart table table-condensed">
        ...
        <tbody>
        <tr>
            <td colspan="2" class="goods"><label> <input type="checkbox" class="check-one check" />ipad</label></td>
            <td></td>
            <td class="selling-price number small-bold-red text-right"
                style="padding-top: 1.1rem;" data-bind="1000">1000</td>
            <td>
