...
<div class="headerBar">
	<div class="topBar">
		<div class="comWidth">
			<div class="leftArea">
				<a href="#" class="collection">收藏首页</a>
			</div>
			<div class="rightArea">
			...
			<div class="description_imgs">
				<div class="big">
					<a href="image_800/<?php echo  $proImgs[0]['albumPath'];?>" class="jqzoom" rel='gal1'  title="triumph" >
           			 <img width="309" height="340" src="uploads/<?php  echo $proImgs[0]['albumPath'];?>"  title="triumph">
	        		</a>
				</div>
		...
		<div class="rightArea">
			<div class="des_content">
				...
				<div class="dl clearfix">
					<div class="dt">二手价</div>
					<div class="dd clearfix"><span class="des_money"><em>￥</em><?php echo $proInfo['internetPrice'];?></span></div>
				</div>
				<div class="dl clearfix">
					<div class="dt">优惠</div>
...
<!--                    购买-->
					<a href="confirmation.php" class="buy_btn"></a>
				</div>
				<div class="notes">
