...
<form action="doAdminAction.php?act=editPro&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
    <table width="70%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
        ...
        <tr>
            ...
            <td><input type="text" name="pStyleID" value="<?php echo $proInfo['pStyleID']; ?>"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="marketPrice" value="<?php echo $proInfo['marketPrice']; ?>"/></td>
        </tr>
        <tr>
            <td align="right">商品二手价</td>
            <td><input type="text" name="internetPrice" value="<?php echo $proInfo['internetPrice']; ?>"/></td>
        </tr>
        <tr>
