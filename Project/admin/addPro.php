...
<form action="doAdminAction.php?act=addPro" method="post" enctype="multipart/form-data">
    <table width="70%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
        ...
        <tr>
            ...
            <td><input type="text" name="pStyleID" placeholder="请输入商品货号"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="marketPrice" placeholder="请输入商品市场价"/></td>
        </tr>
        <tr>
            <td align="right">商品二手价</td>
            <td><input type="text" name="internetPrice" placeholder="请输入商品慕课价"/></td>
        </tr>
        <tr>
